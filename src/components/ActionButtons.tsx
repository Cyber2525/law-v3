        ...
        <div className="pt-4 flex justify-center">
          <button 
            ...
            className={`text-base flex items-center transition-all duration-200 outline-none select-none ${
                ...
                : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 cursor-pointer opacity-100 active:opacity-50'
            }`}
          >
              {config.mainPage.bottomButtonText} <ExternalLink className="w-5 h-5 ml-1" />
          </button>
        </div>
      </div>
