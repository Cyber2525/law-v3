...
interface DebugOSOverrideProps {
    isVisible?: boolean;
    onDisable?: () => void;
}

export const DebugOSOverride: React.FC<DebugOSOverrideProps> = ({ isVisible = false, onDisable }) => {
      ...
      {isMounted && createPortal(
        <>
            {/* 
              ...
              z-index 99990 is below IOSAlert (99999) as requested.
            */}
            <div 
